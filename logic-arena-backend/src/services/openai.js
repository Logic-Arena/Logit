...
export async function judgeDebate({ topic, content, mode = 'ai_debate' }) {
  ...
  const prompt =
    ...
    `【논리성 0~20점】\n` +
    `17~20: 주장과 이유가 자연스럽게 이어지고 앞뒤가 맞음\n` +
    `13~16: 대체로 이어지나 한두 군데 연결이 어색함\n` +
    `8~12: 이유가 있긴 하나 주장이랑 자주 어긋남\n` +
    `4~7: 주장과 이유가 따로 노는 경우가 많음\n` +
    `0~3: 그냥 생각을 나열한 수준\n\n` +
    `【근거 0~20점】\n` +
    `17~20: 책, 뉴스, 실제 사례 등 믿을 수 있는 근거를 구체적으로 제시함\n` +
    `13~16: 근거가 있지만 어디서 나온 건지 불분명함\n` +
    `8~12: "~라고 들었다" 수준의 막연한 근거만 있음\n` +
    `4~7: 근거가 추측이거나 본인 경험에만 의존함\n` +
    `0~3: 근거가 거의 없음\n\n` +
    `【설득력 0~20점】\n` +
    `17~20: 말이 명확하고 듣는 사람이 이해하기 쉬움. 감정에 호소하지 않음\n` +
    `13~16: 대체로 잘 전달되나 일부 표현이 애매함\n` +
    `8~12: 전하려는 말은 있는데 구성이 산만함\n` +
    `4~7: 같은 말을 반복하거나 무슨 말인지 파악하기 어려움\n` +
    `0~3: 무슨 말을 하려는지 거의 알 수 없음\n\n` +
    `【반론 0~20점】\n` +
    `17~20: 상대 주장의 핵심을 정확히 짚고 구체적인 이유로 반박함\n` +
    `13~16: 핵심은 짚었으나 반박이 다소 약함\n` +
    `8~12: 상대 말 일부만 다루거나 "그건 틀렸다"는 수준에 머묾\n` +
    `4~7: 상대 말을 잘못 이해했거나 엉뚱한 반박을 함\n` +
    `0~3: 반론이 거의 없음\n\n` +
    `【일관성 0~20점】\n` +
    `17~20: 처음부터 끝까지 같은 입장을 유지하고 앞뒤 발언이 서로 모순되지 않음\n` +
